...
# ================================================================================================================================
    ...
    with ui.panel_conditional("input.view == 'Explore'"):
...
# ================================================================================================================================
    ...
    with ui.panel_conditional("input.view == 'Our Journey'"):
        @render_plotly
        def journey_map():
...
# Dataframe tab
# ================================================================================================================================
    with ui.panel_conditional("input.view == 'Dataframe'"):
        @render.data_frame
        def dataframe_table():
            df = filtered_df()
...
# ================================================================================================================================
    ...
    with ui.panel_conditional("input.view == 'Transfers'"):
        with ui.value_box():
            "Jesse Owes"
            @render.express
            def jesse_owes():
...
# ================================================================================================================================
    ...
    with ui.panel_conditional("input.view == 'Forecast'"):
